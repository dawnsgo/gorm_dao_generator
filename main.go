...
func usage() {
	fmt.Fprintf(os.Stderr, "Usage of gorm_dao_generator:\n")
	fmt.Fprintf(os.Stderr, "\tgorm_dao_generator [flags] -model-dir=. -model-names=M[:t],M[:t] -dao-dir=./dao\n")
	fmt.Fprintf(os.Stderr, "For more information, see:\n")
	fmt.Fprintf(os.Stderr, "\thttps://github.com/dawnsgo/gorm_dao_generator\n")
	fmt.Fprintf(os.Stderr, "Flags:\n")
	flag.PrintDefaults()
}

//go:generate gorm_dao_generator -model-names=Mail,User
//go:generate gorm_dao_generator -model-names=Mail:email,User:user
//go:generate gorm_dao_generator -model-names=Mail:email,User
//go:generate gorm_dao_generator -model-names=Mail,User:user
func main() {
	log.SetFlags(0)
	log.SetPrefix("gorm_dao_generator: ")
	flag.Usage = usage
	flag.Parse()
